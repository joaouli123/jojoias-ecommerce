...
export default async function Home() {
  ...
  return (
    <div className="flex flex-col w-full bg-white overflow-hidden relative">
      ...
      <Link href={settings.whatsappUrl} target="_blank" rel="noreferrer" aria-label="Falar com a JoJoias no WhatsApp" className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
