...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  return generateCategoryMetadata({ params: Promise.resolve({ slug: normalizeCategorySlug(resolved.slug) }) });
}
...
export default async function CategoriaPage({
  ...
  return CategoryPage({
    params: Promise.resolve({ slug: normalizeCategorySlug(resolved.slug) }),
    searchParams,
  });
}