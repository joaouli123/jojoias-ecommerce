...
export function ProductDetailsTabs({
  ...
  return (
    <div className="w-full border-t border-zinc-200 pt-8 md:pt-10">
      <div className="flex items-center gap-6 md:gap-8 border-b border-zinc-200 mb-6 md:mb-8 overflow-x-auto">
      ...
      {activeTab === "description" ? (
        <div className="max-w-4xl text-[15px] text-[#4b5563] leading-[1.8] space-y-5 md:space-y-6">
      ...
      {activeTab === "specs" ? (
        <div className="max-w-4xl overflow-hidden rounded-[20px] border border-zinc-200 bg-white shadow-[0_12px_32px_-28px_rgba(15,23,42,0.35)]">
