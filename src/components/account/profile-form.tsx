  ...
  return (
    <form action={onSubmit} className="space-y-5 rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500">Mantenha suas informações atualizadas para pedidos e comunicação.</p>
      </div>

      <div className="grid gap-4 md:grid-cols-2">
        <div className="space-y-2">
          <label htmlFor="name" className="text-sm font-semibold text-zinc-700">Nome completo</label>
      ...
      <div className="space-y-2">
        <label htmlFor="phone" className="text-sm font-semibold text-zinc-700">Telefone</label>
      ...
      <button type="submit" disabled={isPending} className="inline-flex h-12 items-center justify-center rounded-xl bg-[#111111] px-5 text-sm font-bold text-white hover:bg-[#111111]/90 disabled:opacity-70">
